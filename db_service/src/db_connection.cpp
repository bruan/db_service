...
bool CDbConnection::connect(const string& szHost, uint16_t nPort, const string& szUser, const string& szPassword, const string& szDbname, const string& szCharacterset)
{
...
uint32_t CDbConnection::execute(const string& szSQL, CDbRecordset** pDbRecordset)
{
...
string CDbConnection::escape(const string& szSQL)
{
