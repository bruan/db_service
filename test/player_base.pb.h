...
class player_base : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.db.player_base) */ {
 public:
  ...
  static const player_base* internal_default_instance();
  ...
  void UnsafeMergeFrom(const player_base& from);
  private:
...
extern ::google::protobuf::internal::ExplicitlyConstructed<player_base> player_base_default_instance_;
...
class player_base_set : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.db.player_base_set) */ {
 public:
  ...
  static const player_base_set* internal_default_instance();
  ...
  void UnsafeMergeFrom(const player_base_set& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<player_base_set> player_base_set_default_instance_;
