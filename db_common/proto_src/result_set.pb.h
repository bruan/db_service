...
class row : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.db.row) */ {
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_result_5fset_2eproto_impl();
  friend void  protobuf_AddDesc_result_5fset_2eproto_impl();
...
class result_set : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:proto.db.result_set) */ {
 public:
  ...
  static const result_set* internal_default_instance();
  ...
  void UnsafeMergeFrom(const result_set& from);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return _internal_metadata_.arena();
  }
...
extern ::google::protobuf::internal::ExplicitlyConstructed<result_set> result_set_default_instance_;
