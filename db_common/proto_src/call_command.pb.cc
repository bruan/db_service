...
void protobuf_AssignDesc_call_5fcommand_2eproto() {
  ...
  call_command_reflection_ =
    ::google::protobuf::internal::GeneratedMessageReflection::NewGeneratedMessageReflection(
      ...
      call_command::default_instance_,
      call_command_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(call_command, _has_bits_[0]),
      -1,
      -1,
      sizeof(call_command),
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
      call_command_descriptor_, &call_command::default_instance());
}

}  // namespace

void protobuf_ShutdownFile_call_5fcommand_2eproto() {
  delete call_command::default_instance_;
  delete call_command_reflection_;
}

void protobuf_AddDesc_call_5fcommand_2eproto() GOOGLE_ATTRIBUTE_COLD;
void protobuf_AddDesc_call_5fcommand_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ommand\022\013\n\003sql\030\001 \002(\t\022\014\n\004args\030\002 \003(\014", 73);
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedFile(
    "call_command.proto", &protobuf_RegisterTypes);
  call_command::default_instance_ = new call_command();
  call_command::default_instance_->InitAsDefaultInstance();
...
const call_command& call_command::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_call_5fcommand_2eproto();
  return *default_instance_;
}

call_command* call_command::default_instance_ = NULL;
...
int call_command::ByteSize() const {
